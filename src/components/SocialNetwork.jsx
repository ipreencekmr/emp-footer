...
export const SocialNetwork = () => {
    return (
        <div className="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
            ...
            <p>
                <a href="https://www.facebook.com/profile.php?id=100083273206168" className="text-reset">
                    <FontAwesomeIcon className="me-3" icon={ faFacebookF }></FontAwesomeIcon>
                  Facebook
                </a>
            </p>
            <p>
                <a href="https://www.linkedin.com/in/ipreencekmr/" className="text-reset">
                    <FontAwesomeIcon className="me-3" icon={ faLinkedinIn }></FontAwesomeIcon>
                  Linked In
                </a>
            </p>
            <p>
                <a href="https://www.instagram.com/ipreencekmr/" className="text-reset">
                    <FontAwesomeIcon className="me-3" icon={ faInstagram }></FontAwesomeIcon>
                  Instagram
                </a>
            </p>
            <p>
                <a href="https://twitter.com/ipreencekmr" className="text-reset">
